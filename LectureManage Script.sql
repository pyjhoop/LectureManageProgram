...
CREATE TABLE TB_INSTRUCTOR(
    ...
    LECTURE_NO NUMBER REFERENCES TB_LECTURE,
...
CREATE TABLE TB_STUDENTINFO(
    ...
    LEC_NO NUMBER CONSTRAINT FK_LEC_NO REFERENCES TB_LECTURE
);
...
COMMENT ON COLUMN TB_STUDENTINFO.LEC_NO IS '강의 번호';


--TB_STUDENTINFO 값 10개 추가하기
INSERT INTO TB_STUDENTINFO VALUES('iahls98f',23,'M','01023123453',1,110);
INSERT INTO TB_STUDENTINFO VALUES('wnymr0gc',41,'M','01046643421',2,130);
INSERT INTO TB_STUDENTINFO VALUES('lkbehqgm',34,'F','01023128768',3,170);
INSERT INTO TB_STUDENTINFO VALUES('buji09wo',45,'F','01088765534',4,120);
INSERT INTO TB_STUDENTINFO VALUES('plsmnuuj',51,'M','01023348857',5,110);
INSERT INTO TB_STUDENTINFO VALUES('enafijpm',21,DEFAULT,'01023488653',6,140);
INSERT INTO TB_STUDENTINFO VALUES('Kahlsf',29,'F','01088649864',7,150);
INSERT INTO TB_STUDENTINFO VALUES('tkhteiaw',19,'M','01023876579',8,160);
INSERT INTO TB_STUDENTINFO VALUES('fosqswzf',32,'F','01067478744',9,180);
INSERT INTO TB_STUDENTINFO VALUES('akxfpclt',26,'M','01010041004',10,190);
